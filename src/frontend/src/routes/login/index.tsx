    ...
    <div class="min-h-screen flex items-center justify-center px-4">
      <div class="bg-zinc-700/90 p-6 sm:p-8 md:p-10 rounded-xl shadow-md w-full max-w-md">
        ...
        <form class="space-y-5 sm:space-y-6" onSubmit={e => handleLogin(e)}>
          ...
          <div>
            <button
              class="w-full bg-blue-600 text-white py-2 px-4 rounded-lg font-semibold hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition text-base"
            >
              Login
            </button>
          </div>
